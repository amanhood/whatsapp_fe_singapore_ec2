...
import typeahead from '@/assets/components/plugins/Typeahead.vue';
...
import vueSelect from '@/assets/components/plugins/VueSelect.vue'
										...
										<div class="row">
											<div class="col-md-6">
												<div class="mb-3">
													...
													<div class="small pt-1 text-body text-opacity-35">Enter 'one', 'two' or 'three' for typeahead preview</div>
												</div>
											</div>
										</div>
									</form>
										...
										<div class="row">
											<div class="col-xl-8">
												<div class="mb-0">
													...
													<div class="small pt-1 text-body text-opacity-35">Enter 'javascript', 'css' for autocomplete preview</div>
												</div>
											</div>
										</div>
									</form>
