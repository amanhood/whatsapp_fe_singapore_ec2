<script>
import tagsInput from '@/assets/components/plugins/TagsInput.vue';
...
<template>
	...
	<div class="mb-md-4 mb-3 d-md-flex">
		<div class="dropdown-toggle">
			<a href="#" data-bs-toggle="dropdown" class="text-body text-decoration-none"><i class="far fa-folder fa-fw fa-lg me-1"></i> project/studio</a>
			<div class="dropdown-menu">
				<a href="#" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg me-1"></i> project/mobile-app-dev</a>
				<a href="#" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg me-1"></i> project/bootstrap-5</a>
				<a href="#" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg me-1"></i> project/mvc-version</a>
				<a href="#" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg me-1"></i> project/ruby-version</a>
			</div>
		</div>
		<div class="ms-md-4 mt-md-0 mt-2"><i class="fa fa-code-branch fa-fw fa-lg me-1"></i> 1,392 pull request</div>
		<div class="ms-md-4 mt-md-0 mt-2"><i class="fa fa-users-cog fa-fw fa-lg me-1"></i> 52 participant</div>
		<div class="ms-md-4 mt-md-0 mt-2"><i class="far fa-clock fa-fw fa-lg me-1"></i> 14 day(s)</div>
	</div>
				...
				<div class="list-group list-group-flush">
					...
					<div class="list-group-item d-flex px-3">
						...
						<div class="flex-fill">
							...
							<div class="fs-13px mb-2">#29949 opened yesterday by Terry</div>
							<div class="">
								<span class="badge bg-theme text-theme-color me-1 rounded-sm fs-12px fw-500">docs</span>
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							...
							<div class="fs-13px mb-2">#29919 opened 9 days ago by xMediaKron</div>
							<div class="mb-1">
								<span class="badge bg-muted text-white rounded-sm fs-12px fw-500 me-1">build</span>
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							...
							<div class="mb-2 fs-13px">#29916 opened 9 days ago by Wasbbok</div>
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							...
							<div class="mb-2 fs-13px">#29796 opened 29 days ago by mdo</div>
							<div class="mb-1">
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							...
							<div class="mb-2 fs-13px">#29919 opened 19 days ago by sean</div>
							<div class="mb-1">
								<span class="badge bg-muted text-white rounded-sm fs-12px fw-500 me-1">design</span>
		...
		<div class="col-xl-4 col-lg-6">
			...
			<div class="card mb-3">
				...
				<div class="list-group list-group-flush">
					...
					<div class="list-group-item d-flex px-3">
						<div class="me-3">
							<i class="fa fa-tools fa-fw fa-lg"></i>
						</div>
						<div class="flex-fill">
							<div class="fw-600">HTML5 flexbox old browser compatibility</div>
							<div class="fs-13px mb-2">#29982 handled by Sean</div>
							<div class="mb-1">
					...
					<div class="list-group-item d-flex px-3">
						...
						<div class="flex-fill">
							...
							<div class="fs-13px mb-2">#29953 handled by Ken</div>
							<div class="mb-1">
								<span class="badge bg-muted text-white rounded-sm fs-12px fw-500 me-1">issue</span>
				...
				<div class="list-group list-group-flush">
					...
					<div class="list-group-item d-flex px-3">
						...
						<div class="flex-fill">
							...
							<div class="fs-13px mb-2">#29930 closed yesterday by Sean</div>
							<div class="mb-1">
								<span class="badge bg-muted text-white rounded-sm fs-12px fw-500 me-1">build</span>
								<span class="badge bg-success text-white rounded-sm fs-12px fw-500">feature</span>
							</div>
