					...
					<div id="basicTable" class="mb-5">
						...
						<card>
							<card-body>
								<div class="row mb-n3">
									<div class="col-xl-6">
										<div class="small text-muted mb-3"><b>DEFAULT TABLE</b></div>
										<table class="table">
											<thead>
												<tr>
													<th scope="col">#</th>
									...
									<div class="col-xl-6">
										<div class="small text-muted mb-3"><b>DARK TABLE</b></div>
					...
					<div id="tableHeadOptions" class="mb-5">
						...
						<card>
							<card-body>
								<div class="row mb-n3">
									<div class="col-xl-6">
										<div class="small text-muted mb-3"><b>DARK HEADER</b></div>
										<table class="table">
									...
									<div class="col-xl-6">
										<div class="small text-muted mb-3"><b>LIGHT HEADER</b></div>
										<table class="table">
