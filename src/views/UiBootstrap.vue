				...
				<div class="row">
					...
					<div class="col-xl-9">
						...
						<div id="jumbotron" class="mb-5">
							...
							<card>
								<card-body>
									<div class="p-5 bg-light mb-0 rounded-3">
								...
								<card-body>
									<div class="row">
										<div class="col-xl-6 mb-xl-0 mb-3">
											<div class="mb-2 small text-muted"><b>BASE NAV</b></div>
											<nav class="nav mb-3">
										...
										<div class="col-xl-6">
											<div class="mb-2 small text-muted"><b>VERTICAL NAV</b></div>
							...
							<card>
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											<div class="mb-3">
												<div class="mb-2 small text-muted"><b>DEFAULT</b></div>
												<div class="progress">
													<div class="progress-bar" style="width: 50%">50%</div>
												</div>
											</div>
											<div class="mb-3">
												<div class="mb-2 small text-muted"><b>MULTIPLE BARS</b></div>
												<div class="progress">
										...
										<div class="col-xl-6">
											<div class="mb-3">
												<div class="mb-2 small text-muted"><b>STRIPED</b></div>
												<div class="progress">
													<div class="progress-bar progress-bar-striped" style="width: 66%">66%</div>
												</div>
											</div>
											<div class="mb-3">
												<div class="mb-2 small text-muted"><b>ANIMATED</b></div>
												<div class="progress">
							...
							<card>
								<card-body class="pb-0">
									<div class="row">
										<div class="col-xl-6">
											<div class="mb-4">
												<div class="mb-2 small text-muted"><b>BORDER SPINNER</b></div>
												<div class="spinner-border"></div>
											</div>
											<div class="mb-4">
												<div class="mb-2 small text-muted"><b>COLORS</b></div>
											...
											<div class="mb-4">
												<div class="mb-2 small text-muted"><b>SIZE</b></div>
										...
										<div class="col-xl-6">
											<div class="mb-4">
												<div class="mb-2 small text-muted"><b>GROWING SPINNER</b></div>
