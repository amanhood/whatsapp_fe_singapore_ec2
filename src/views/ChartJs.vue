	...
	methods: {
		...
		getChart2Data() {
			return {
				...
				datasets: [{
					...
					backgroundColor: 'rgba('+ appVariable.color.bodyColorRgb +', .2)',
					borderColor: 'rgba('+ appVariable.color.bodyColorRgb +', .65)',
					borderWidth: 1.5
				}]
			};
		},
		...
		getChart4Data() {
			return {
				datasets: [{
					data: [11, 16, 7, 3, 14],
					backgroundColor: ['rgba('+ appVariable.color.themeRgb +', .5)', 'rgba('+ appVariable.color.bodyColorRgb +', .2)' +', .5)', 'rgba('+ appVariable.color.gray300Rgb +', .5)', 'rgba('+ appVariable.color.gray500Rgb +', .5)', 'rgba('+ appVariable.color.gray800Rgb +', .5)'],
					borderWidth: 0
				}],
		...
		getChart5Data() {
			return {
				...
				datasets: [{
					data: [300, 50, 100],
					backgroundColor: ['rgba('+ appVariable.color.themeRgb +', .5)', 'rgba('+ appVariable.color.bodyColorRgb +', .2)' +', .5)', 'rgba('+ appVariable.color.themeRgb +', .5)'],
					hoverBackgroundColor: ['rgba('+ appVariable.color.themeRgb +', 1)', 'rgba('+ appVariable.color.bodyColorRgb +', 1)', 'rgba('+ appVariable.color.gray900Rgb +', 1)'],
					borderWidth: 0
				}]
			};
		},
		getChart6Data() {
			return {
				...
				datasets: [{
					data: [300, 50, 100],
					backgroundColor: ['rgba('+ appVariable.color.themeRgb +', .5)', 'rgba('+ appVariable.color.bodyColorRgb +', .2)' +', .5)', 'rgba('+ appVariable.color.themeRgb +', .5)'],
					hoverBackgroundColor: [appVariable.color.theme, appVariable.color.bodyColor, appVariable.color.gray900],
					borderWidth: 0
				}]
			};
		}
