				...
				<div class="row">
					...
					<div class="col-xl-9">
						...
						<div id="modalSizes" class="mb-5">
							...
							<card>
								<card-body>
									<!-- modal-xl -->
									<button type="button" class="btn btn-default me-2" data-bs-toggle="modal" data-bs-target="#modalXl">Extra large modal</button>

									<!-- modal-lg -->
									<button type="button" class="btn btn-default me-2" data-bs-toggle="modal" data-bs-target="#modalLg">Large modal</button>

									<!-- modal-sm -->
									<button type="button" class="btn btn-default me-2" data-bs-toggle="modal" data-bs-target="#modalSm">Small modal</button>
								</card-body>
						...
						<div id="modalCover" class="mb-5">
							...
							<card>
								<card-body>
									<!-- modal-cover -->
									<button type="button" class="btn btn-default me-2" data-bs-toggle="modal" data-bs-target="#modalCoverExample">Modal Cover</button>
								</card-body>
						...
						<div id="toastsContainer" class="mb-5">
							...
							<card>
								<card-body>
									<a href="#" class="btn btn-default me-2" @click="(event) => showToast(event, 'toast-1')">Show toast 1</a>
									<a href="#" class="btn btn-default"  @click="(event) => showToast(event, 'toast-2')">Show toast 2</a>
								</card-body>
					...
					<div class="col-xl-3">
						...
						<nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
							<nav class="nav">
								<nav-scroll-to target="#modal" data-toggle="scroll-to">Modal</nav-scroll-to>
								<nav-scroll-to target="#modalSizes" data-toggle="scroll-to">Modal Sizes</nav-scroll-to>
								<nav-scroll-to target="#modalCover" data-toggle="scroll-to">Modal Cover</nav-scroll-to>
								<nav-scroll-to target="#toastsNotification" data-toggle="scroll-to">Toasts Notification</nav-scroll-to>
								<nav-scroll-to target="#toastsContainer" data-toggle="scroll-to">Toasts Container</nav-scroll-to>
							</nav>
						</nav>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row mb-5">
						...
						<div class="col-md-3">
							<button type="button" class="btn btn-theme btn-lg btn-block">Continue</button>
						</div>
					</div>
					<div class="pt-3">
