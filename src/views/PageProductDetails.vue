					...
					<tbody class="files">
						<tr class="empty-row">
							<td colspan="4" class="text-center p-3">
								<div class="text-body text-opacity-30 mb-2"><i class="fa fa-file-archive fa-3x"></i></div>
								No file uploaded
							</td>
						</tr>
					</tbody>
			...
			<card class="mb-4">
				...
				<card-body>
					...
					<div class="row mb-3 gx-3">
						...
						<div class="col-1">
							<a href="#" class="btn btn-default d-block"><i class="fa fa-xmark"></i></a>
						</div>
					</div>
					<div class="row mb-3 gx-3">
				...
				<card-body>
					<div class="d-flex">
						<div class="flex-1 d-flex">
							<div class="me-2"><i class="fa fa-store fa-lg fa-fw text-body text-opacity-50"></i></div>
							<div>Online Store</div>
							<span class="badge bg-theme bg-opacity-15 text-theme fw-bold fs-12px ms-auto me-2">2022-01-05</span>
						</div>
						<div class="w-50px text-center"><a href="#" class="text-decoration-none"><i class="fa fa-calendar fa-lg"></i></a></div>
					</div>
					<hr />
					<div class="d-flex">
						<div class="flex-1 d-flex">
							<div class="me-2"><i class="fab fa-shopify fa-lg fa-fw text-body text-opacity-50"></i></div>
							<div>Shopify</div>
							<span class="badge bg-theme bg-opacity-15 text-theme fw-bold fs-12px ms-auto me-2">2022-01-05</span>
						</div>
						<div class="w-50px text-center"><a href="#" class="text-decoration-none"><i class="fa fa-calendar fa-lg"></i></a></div>
					...
					<div class="d-flex">
						<div class="flex-1 d-flex">
							<div class="me-2"><i class="fab fa-amazon fa-lg fa-fw text-body text-opacity-50"></i></div>
							<div>
								<div>Amazon</div>
						...
						<div class="w-50px text-center"><a href="#" class="text-decoration-none text-body text-opacity-50"><i class="fa fa-circle-xmark fa-lg fa-fw"></i></a></div>
					</div>
				</card-body>
			</card>
			<card class="mb-4">
