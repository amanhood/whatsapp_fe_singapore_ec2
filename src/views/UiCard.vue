										...
										<div class="col-sm-8">
											<card>
												<card-body>
													...
													<a href="#" class="btn btn-default">Go somewhere</a>
												</card-body>
											</card>
										</div>
									</div>
						...
						<div id="navigation" class="mb-5">
							...
							<card>
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											<div class="small text-muted mb-3"><b>NAV TABS</b></div>
											<card class="mb-3">
												<card-header>
												...
												<card-body>
													<h5 class="card-title">Special title treatment</h5>
													<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
													<a href="#" class="btn btn-theme">Go somewhere</a>
												</card-body>
											</card>
										</div>
										<div class="col-xl-6">
											<div class="small text-muted mb-3"><b>NAV PILLS</b></div>
											<card class="mb-3">
												<card-header>
						...
						<div id="images" class="mb-5">
							...
							<card>
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											<div class="small text-muted mb-3"><b>IMAGE CAPS</b></div>
											<card class="mb-3">
												<card-body class="p-0">
										...
										<div class="col-xl-6">
											<div class="small text-muted mb-3"><b>IMAGE OVERLAY</b></div>
											<card class="mb-3">
												<img src="https://via.placeholder.com/600x650/000000/ffffff" alt="" class="card-img" />
												<card-img-overlay class="text-white">
													<h5 class="card-title">Card title</h5>
													<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
						...
						<div id="cardStyles" class="mb-5">
							...
							<card>
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											<div class="small text-muted mb-3"><b>BACKGROUND AND BORDER</b></div>
											<card class="border-theme bg-theme bg-opacity-25 mb-3">
												<card-header class="border-theme fw-bold small">HEADER</card-header>
												<card-body>
										...
										<div class="col-xl-6">
											<div class="small text-muted mb-3"><b>BORDER AND COLOR</b></div>
